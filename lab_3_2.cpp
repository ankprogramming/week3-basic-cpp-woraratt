...
int main() {
  // เขียนโปรแกรมเพิ่ม เพื่อหาขนาดตัวแปรที่กำหนด
   ...
   cout << "Min of long wchar_t: " << numeric_limits<wchar_t>::min() << endl;
   cout << "Max of long wchar_t : " << numeric_limits<wchar_t>::max() << endl;

   cout << "Min of long bool: " << numeric_limits<bool>::min() << endl;
   cout << "Max of long bool : " << numeric_limits<bool>::max() << endl;
